...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <a href="{{ route('berita') }}" class="inline-flex items-center text-green-600 hover:text-green-800 mb-6">
        ...
        <article class="bg-white rounded-xl shadow-md overflow-hidden">
            <header class="relative">
                ...
                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-8">
                    ...
                    <h1 class="text-3xl md:text-4xl font-bold text-white">{{ $news->title }}</h1>
                </div>
            </header>
            ...
            <div class="p-8">
                <div class="flex items-center border-b border-gray-200 pb-6 mb-8">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">{{ $news->author->name ?? 'Admin' }}</p>
        ...
        <div class="mt-8 flex justify-between">
            <a href="{{ route('berita') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg transition-colors">
                <i class="fas fa-arrow-left mr-2"></i>
                Berita Lainnya
            </a>
        </div>
