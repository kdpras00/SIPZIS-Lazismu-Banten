...
<style>
    ...
    .delay-1800 { animation-delay: 1.8s; animation-fill-mode: both; }
    ...
    <div class="dashboard-content p-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-3">
                <div class="glass-card stat-card-emerald p-4 animate-fadeInUp">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-green-100 text-uppercase small mb-2">Total Zakat {{ date('Y') }}</p>
                            <h3 class="text-white-custom fw-bold mb-1">
                                Rp {{ number_format($stats['total_payments_this_year'], 0, ',', '.') }}
                            </h3>
                            <small class="text-green-200">
                                +{{ number_format($stats['total_payments_this_month'], 0, ',', '.') }} bulan ini
                            </small>
                        </div>
                        <div class="bg-success bg-opacity-75 p-3 rounded-3">
            ...
            <!-- Distribusi Card -->
            <div class="col-md-3 mb-3">
                <div class="glass-card stat-card-yellow p-4 animate-fadeInUp delay-200">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                        ...
                        <div class="bg-warning bg-opacity-75 p-3 rounded-3">
            ...
            <!-- Total Muzakki Card -->
            <div class="col-md-3 mb-3">
                <div class="glass-card stat-card-blue p-4 animate-fadeInUp delay-400">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                        ...
                        <div class="bg-info bg-opacity-75 p-3 rounded-3">
            ...
            <!-- Mustahik Card -->
            <div class="col-md-3 mb-3">
                <div class="glass-card stat-card-purple p-4 animate-fadeInUp delay-600">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                        ...
                        <div class="bg-secondary bg-opacity-75 p-3 rounded-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 mb-4">
                <div class="glass-card p-4 animate-fadeInUp delay-800">
            ...
            <div class="col-lg-4 mb-4">
                <div class="glass-card p-4 animate-fadeInUp delay-800">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h4 class="text-white-custom fw-bold mb-0">Saldo Zakat</h4>
                    </div>
                    
                    <!-- <div class="d-grid gap-3">
                        <a href="{{ route('payments.create') }}" class="btn btn-gradient-green py-3">
                            <i class="fas fa-plus-circle me-2"></i>Tambah Pembayaran
                        </a>
                        <a href="{{ route('distributions.create') }}" class="btn btn-gradient-blue py-3">
                            <i class="fas fa-hands-helping me-2"></i>Distribusi Zakat
                        </a>
                        <a href="{{ route('muzakki.create') }}" class="btn py-3" style="background: linear-gradient(135deg, #8b5cf6 0%, #ec4899 100%); border: none; color: white;">
                            <i class="fas fa-user-plus me-2"></i>Daftar Muzakki
                        </a>
                        <a href="{{ route('mustahik.create') }}" class="btn py-3" style="background: linear-gradient(135deg, #f59e0b 0%, #ea580c 100%); border: none; color: white;">
                            <i class="fas fa-heart me-2"></i>Daftar Mustahik
                        </a>
                    </div> -->
                    ...
                    <div class="text-center">
                        <!-- <h5 class="text-white-custom fw-semibold mb-3">Saldo Zakat</h5> -->
                        @php $balance = $stats['total_payments_this_year'] - $stats['total_distributions_this_year']; @endphp
                        <div class="bg-white bg-opacity-20 rounded-3 p-3">
                            <h3 class="fw-bold mb-0 {{ $balance > 0 ? 'text-success' : ($balance < 0 ? 'text-danger' : 'text-muted') }}">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-6 mb-4">
                <div class="glass-card shadow-xl animate-fadeInUp delay-1200">
                    <div class="d-flex justify-content-between align-items-center p-4 border-bottom border-white border-opacity-25">
                    ...
                    <div class="p-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center p-4 border-bottom border-white border-opacity-10">
                            <div>
                                ...
                                <p class="text-green-200 small mb-0">{{ $payment->zakatType->name }}</p>
                            </div>
                            <div class="text-end">
            ...
            <div class="col-lg-6 mb-4">
                <div class="glass-card shadow-xl animate-fadeInUp delay-1400">
                    <div class="d-flex justify-content-between align-items-center p-4 border-bottom border-white border-opacity-25">
                        <div class="d-flex align-items-center">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                <div class="glass-card p-4 shadow-xl animate-fadeInUp delay-1600">
                    <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="row g-3">
                        @forelse($zakatTypeStats as $stat)
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center p-3 bg-white bg-opacity-10 rounded">
                                <div>
                                    <h6 class="text-white-custom fw-semibold mb-0">{{ $stat->zakatType->name ?? 'Unknown' }}</h6>
                                </div>
                                <div class="text-end">
            ...
            <div class="col-lg-6 mb-4">
                <div class="glass-card p-4 shadow-xl animate-fadeInUp delay-1800">
                    <div class="d-flex align-items-center mb-4">
                        <div class="bg-warning bg-opacity-75 p-3 rounded-3 me-3">
