        ...
        <div class="ms-auto d-flex align-items-center">
            <div class="dropdown me-4">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0" style="min-width: 300px;">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-start py-2" href="{{ route('mustahik.index', ['status' => 'pending']) }}">
                            <div class="me-2 mt-1">
                    ...
                    <li>
                        <a class="dropdown-item text-center" href="{{ $user->role === 'muzakki' ? route('muzakki.notifications.index') : '#' }}">Lihat semua notifikasi</a>
                    </li>
                    @else
