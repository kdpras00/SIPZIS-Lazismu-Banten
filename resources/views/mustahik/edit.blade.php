...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="mb-1">Edit Mustahik</h2>
        <p class="text-muted">Mengubah data mustahik (penerima zakat) dalam sistem</p>
    </div>
    <div>
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Form Edit Mustahik</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('mustahik.update', $mustahik) }}" method="POST" id="mustahikForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('gender') is-invalid @enderror" 
                                    ...
                                    <option value="male" {{ old('gender', $mustahik->gender) == 'male' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="female" {{ old('gender', $mustahik->gender) == 'female' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                                @error('gender')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      name="address" 
                                      rows="3"
                                      placeholder="Jalan, RT/RW, Kelurahan, Kecamatan">{{ old('address', $mustahik->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="province" 
                                       name="province" 
                                       value="{{ old('province', $mustahik->province) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" 
                                    ...
                                    <option value="{{ $key }}" {{ old('category', $mustahik->category) == $key ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="family_members" 
                                       name="family_members" 
                                       value="{{ old('family_members', $mustahik->family_members) }}"
                                       min="1" 
                                       required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('family_status') is-invalid @enderror" 
                                    ...
                                    <option value="single" {{ old('family_status', $mustahik->family_status) == 'single' ? 'selected' : '' }}>Lajang</option>
                                    <option value="married" {{ old('family_status', $mustahik->family_status) == 'married' ? 'selected' : '' }}>Menikah</option>
                                    <option value="divorced" {{ old('family_status', $mustahik->family_status) == 'divorced' ? 'selected' : '' }}>Cerai</option>
                                    <option value="widow/widower" {{ old('family_status', $mustahik->family_status) == 'widow/widower' ? 'selected' : '' }}>Janda/Duda</option>
                                </select>
                                @error('family_status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="monthly_income" 
                                       name="monthly_income" 
                                       value="{{ old('monthly_income', $mustahik->monthly_income) }}"
                                       min="0"
                                       placeholder="0">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('verification_status') is-invalid @enderror" 
                                        ...
                                        required>
                                    <option value="pending" {{ old('verification_status', $mustahik->verification_status) == 'pending' ? 'selected' : '' }}>Menunggu Verifikasi</option>
                                    <option value="verified" {{ old('verification_status', $mustahik->verification_status) == 'verified' ? 'selected' : '' }}>Terverifikasi</option>
                                    <option value="rejected" {{ old('verification_status', $mustahik->verification_status) == 'rejected' ? 'selected' : '' }}>Ditolak</option>
                                </select>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input @error('is_active') is-invalid @enderror" 
                                   ...
                                   name="is_active" 
                                   value="1" 
                                   {{ old('is_active', $mustahik->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <a href="{{ route('mustahik.show', $mustahik) }}" class="btn btn-outline-info">
                                <i class="bi bi-eye"></i> Lihat Detail
                            </a>
                        </div>
                        <div>
                            <a href="{{ route('mustahik.index') }}" class="btn btn-outline-secondary me-2">
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body">
                <table class="table table-borderless small">
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-{{ $mustahik->is_active ? 'success' : 'danger' }}">
                    ...
                    <tr>
                        ...
                        <td>{{ $mustahik->created_at->format('d F Y') }}</td>
                    </tr>
                    <tr>
                        <td class="text-muted">Terakhir Diupdate</td>
                        <td>{{ $mustahik->updated_at->format('d F Y') }}</td>
                    </tr>
                    @if($mustahik->verified_at)
                    <tr>
                        <td class="text-muted">Diverifikasi</td>
                        <td>{{ $mustahik->verified_at->format('d F Y') }}</td>
                    </tr>
                    @endif
                </table>
            </div>
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-success text-white">
                <h6 class="mb-0">
                    <i class="bi bi-wallet2"></i> Statistik Penerimaan Zakat
                </h6>
            </div>
            <div class="card-body">
                <div class="text-center mb-3">
                    <h4 class="text-success mb-0">Rp {{ number_format($mustahik->zakatDistributions()->sum('amount'), 0, ',', '.') }}</h4>
                ...
                <table class="table table-borderless small">
                    <tr>
                        ...
                        <td class="text-end">{{ $mustahik->zakatDistributions()->count() }}</td>
                    </tr>
                    <tr>
                        <td class="text-muted">Distribusi Terakhir</td>
                        <td class="text-end">
                            @php
                                $lastDistribution = $mustahik->zakatDistributions()->latest('distribution_date')->first();
                            @endphp
                ...
                <div class="alert alert-warning small mb-0">
                    ...
                    Berhati-hati saat mengubah data mustahik yang sudah memiliki riwayat distribusi.
                </div>
            </div>
        </div>
        @endif
