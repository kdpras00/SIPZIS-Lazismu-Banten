...
@section('title', 'Zakat Mal - SIPZIS')
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="text-center mb-12 relative">
                ...
                <p class="text-xl text-amber-800 max-w-2xl mx-auto">
                    Zakat harta yang wajib dikeluarkan ketika harta telah mencapai nisab dan haul
                </p>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="mt-6 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl p-6 border border-amber-200">
                                ...
                                <p class="text-center text-amber-600 mt-2">dari semua campaign zakat mal</p>
                        ...
                        <div class="lg:col-span-2">
                            <h2 class="text-3xl font-bold text-amber-800 mb-4">Tentang Zakat Mal</h2>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                                Zakat Mal adalah zakat yang wajib dikeluarkan atas harta yang dimiliki secara pribadi dan mencukupi syarat nisab serta haul (satu tahun kepemilikan). Zakat mal mencakup berbagai jenis harta seperti emas, perak, uang, perdagangan, hasil pertanian, hasil pertambangan, hasil laut, dan harta lainnya.
                            </p>

                            <h3 class="text-2xl font-bold text-amber-700 mb-3">Syarat Zakat Mal</h3>
                            <ul class="list-disc list-inside text-gray-700 mb-6 space-y-2">
                                <li>Harta mencukupi nisab (85 gram emas atau setara)</li>
                                <li>Kepemilikan harta selama satu tahun (haul)</li>
                                <li>Harta bersih dari hutang</li>
                                <li>Harta halal dan tidak berasal dari sumber yang haram</li>
                            </ul>
                            ...
                            <div class="bg-amber-50 rounded-xl p-4 mb-6">
                                ...
                                <ul class="space-y-1 text-amber-700">
                                    ...
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Program pemberdayaan mustahik</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                            ...
                            <div class="text-center mt-8">
                                <a href="{{ route('guest.payment.create', ['category' => 'zakat-mal']) }}"
