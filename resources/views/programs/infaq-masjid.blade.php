...
@section('title', 'Infaq Masjid - SIPZIS')
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="text-center mb-12 relative">
                ...
                <p class="text-xl text-amber-800 max-w-2xl mx-auto">
                    Kontribusi untuk pembangunan, renovasi, dan pemeliharaan masjid serta fasilitas ibadah
                </p>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            <div class="rounded-2xl overflow-hidden shadow-lg">
                                <img src="{{ asset('img/program/infaq-masjid.jpg') }}" alt="Infaq Masjid" class="w-full h-64 object-cover">
                            </div>
                            ...
                            <div class="mt-6 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl p-6 border border-amber-200">
                                ...
                                <p class="text-center text-amber-600 mt-2">dari semua campaign infaq masjid</p>
                        ...
                        <div class="lg:col-span-2">
                            <h2 class="text-3xl font-bold text-amber-800 mb-4">Tentang Infaq Masjid</h2>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                                Infaq Masjid adalah bentuk sedekah yang diberikan untuk keperluan pembangunan, renovasi, pemeliharaan, dan pengembangan masjid serta fasilitas ibadah lainnya. Infaq ini merupakan amalan yang terus mengalir manfaatnya selama masjid tersebut digunakan oleh umat Islam.
                            </p>

                            <h3 class="text-2xl font-bold text-amber-700 mb-3">Penggunaan Infaq Masjid</h3>
                            <ul class="list-disc list-inside text-gray-700 mb-6 space-y-2">
                                <li>Pembangunan masjid baru</li>
                                <li>Renovasi dan perbaikan masjid</li>
                                <li>Pembelian perlengkapan ibadah</li>
                                <li>Pemeliharaan fasilitas masjid</li>
                                <li>Pembayaran listrik, air, dan kebutuhan operasional masjid</li>
                            </ul>
                            ...
                            <div class="bg-amber-50 rounded-xl p-4 mb-6">
                                ...
                                <ul class="space-y-1 text-amber-700">
                                    <li class="flex items-start">
                                        ...
                                        <span>Pembangunan dan renovasi masjid</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Pembelian perlengkapan ibadah</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Pemeliharaan fasilitas masjid</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="text-center mt-8">
                                <a href="{{ route('guest.payment.create', ['category' => 'infaq-masjid', 'amount' => 25000]) }}"
