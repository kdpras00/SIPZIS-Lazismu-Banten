    ...
    <div class="relative z-10 py-20">
        <div class="container mx-auto px-4 py-16">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="mt-6 bg-gradient-to-br from-teal-100 to-cyan-100 rounded-2xl p-6 border border-teal-200">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="flex justify-between text-xs mt-1 text-teal-600">
            ...
            <div class="relative bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20 mt-8">
                ...
                <div class="relative z-10">
                    <h2 class="text-3xl font-bold text-teal-800 mb-6 text-center">Donasi Terbaru</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6 border border-teal-200 shadow-md hover:shadow-lg transition-shadow duration-300">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                                <div class="flex items-center mb-3 sm:mb-0">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-teal-800">{{ $donation->muzakki->name ?? 'Hamba Allah' }}</h3>
                                        <p class="text-teal-600 text-sm">{{ $donation->payment_date->format('d M Y') }}</p>
                                    </div>
                                </div>
                                <div class="flex flex-col sm:items-end">
                                    <p class="text-2xl font-bold text-teal-700">Rp {{ number_format($donation->paid_amount, 0, ',', '.') }}</p>
                                    <p class="text-teal-600 text-sm">{{ $donation->payment_date->diffForHumans() }}</p>
                                </div>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="text-center py-12">
                        <svg class="w-16 h-16 mx-auto text-teal-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z"></path>
                        </svg>
                        <h3 class="mt-4 text-xl font-medium text-teal-800">Belum Ada Donasi</h3>
                        <p class="mt-2 text-teal-600">Jadilah yang pertama berdonasi untuk program ini.</p>
                    </div>
                    @endif
                </div>
            </div>
