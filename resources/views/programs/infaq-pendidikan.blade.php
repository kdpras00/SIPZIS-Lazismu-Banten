...
@section('title', 'Infaq Pendidikan - SIPZIS')
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="text-center mb-12 relative">
                ...
                <p class="text-xl text-blue-800 max-w-2xl mx-auto">
                    Dukungan untuk program pendidikan, beasiswa, dan fasilitas belajar
                </p>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            <div class="rounded-2xl overflow-hidden shadow-lg">
                                <img src="{{ asset('img/program/infaq-pendidikan.jpg') }}" alt="Infaq Pendidikan" class="w-full h-64 object-cover">
                            </div>
                            ...
                            <div class="mt-6 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl p-6 border border-blue-200">
                                ...
                                <p class="text-center text-blue-600 mt-2">dari semua campaign infaq pendidikan</p>
                        ...
                        <div class="lg:col-span-2">
                            <h2 class="text-3xl font-bold text-blue-800 mb-4">Tentang Infaq Pendidikan</h2>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                                Infaq Pendidikan adalah bentuk sedekah yang diberikan untuk mendukung program-program pendidikan seperti beasiswa, pembangunan sekolah, penyediaan fasilitas belajar, dan kegiatan edukasi lainnya. Infaq ini merupakan investasi terbaik untuk masa depan generasi bangsa.
                            </p>

                            <h3 class="text-2xl font-bold text-blue-700 mb-3">Fokus Infaq Pendidikan</h3>
                            ...
                            <div class="bg-blue-50 rounded-xl p-4 mb-6">
                                ...
                                <ul class="space-y-1 text-blue-700">
                                    <li class="flex items-start">
                                        ...
                                        <span>Beasiswa bagi pelajar kurang mampu</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-blue-500 mr-2">•</span>
                                        <span>Pembangunan dan renovasi fasilitas sekolah</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-blue-500 mr-2">•</span>
                                        <span>Penyediaan alat peraga dan buku pelajaran</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="text-center mt-8">
                                <a href="{{ route('guest.payment.create', ['category' => 'infaq-pendidikan', 'amount' => 30000]) }}"
