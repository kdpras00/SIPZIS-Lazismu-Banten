        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="text-center mb-12 relative">
                ...
                <p class="text-xl text-amber-800 max-w-2xl mx-auto">
                    Tebusan untuk kewajiban ibadah yang tidak dilaksanakan
                </p>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="mt-6 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl p-6 border border-amber-200">
                                ...
                                <p class="text-center text-amber-600 mt-2">dari semua campaign fidyah</p>
                        ...
                        <div class="lg:col-span-2">
                            <h2 class="text-3xl font-bold text-amber-800 mb-4">Tentang Fidyah</h2>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                                Fidyah adalah tebusan yang dikeluarkan sebagai pengganti kewajiban ibadah yang tidak dilaksanakan atau tidak dapat dilaksanakan. Fidyah biasanya dikeluarkan untuk mengganti puasa Ramadhan yang tidak diqadha sebelum Ramadhan berikutnya tiba, atau untuk mengganti kewajiban haji yang tidak dilaksanakan tanpa alasan yang sah.
                            </p>

                            <h3 class="text-2xl font-bold text-amber-700 mb-3">Jenis Fidyah</h3>
                            <ul class="list-disc list-inside text-gray-700 mb-6 space-y-2">
                                <li>Fidyah puasa Ramadhan yang tidak diqadha</li>
                                <li>Fidyah haji yang tidak dilaksanakan</li>
                                <li>Fidyah kaffarah (tebusan dosa besar)</li>
                                <li>Fidyah nadzar (janji yang tidak ditepati)</li>
                            </ul>
                            ...
                            <div class="bg-amber-50 rounded-xl p-4 mb-6">
                                ...
                                <ul class="space-y-1 text-amber-700">
                                    <li class="flex items-start">
                                        ...
                                        <span>Pembagian makanan kepada fakir miskin</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Bantuan pangan untuk mustahik</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
