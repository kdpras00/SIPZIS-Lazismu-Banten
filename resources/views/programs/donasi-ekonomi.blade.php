        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="text-center mb-12 relative">
                ...
                <p class="text-xl text-amber-800 max-w-2xl mx-auto">
                    Memberdayakan masyarakat secara ekonomi melalui berbagai inisiatif
                </p>
            </div>
                            ...
                            <div class="bg-amber-50 rounded-xl p-4 mb-6">
                                ...
                                <ul class="space-y-1 text-amber-700">
                                    <li class="flex items-start">
                                        ...
                                        <span>Penyediaan modal usaha bagi pelaku UMKM</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Pelatihan keterampilan dan pengembangan kapasitas</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Pengembangan pasar dan jaringan distribusi</span>
                                    </li>
                                </ul>
                            </div>
