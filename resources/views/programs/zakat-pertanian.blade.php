...
@section('title', 'Zakat Pertanian - SIPZIS')
...
@section('content')
<div class="relative bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-100 min-h-screen overflow-hidden">
    <!-- Animated Background Elements -->
    <div class="absolute inset-0">
        <div class="absolute inset-0 bg-gradient-to-br from-amber-600/40 via-orange-600/30 to-yellow-600/40"></div>
        ...
        <div class="absolute -bottom-8 left-20 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-bounce animation-delay-5000"></div>
    </div>
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="text-center mb-12 relative">
                ...
                <p class="text-xl text-amber-800 max-w-2xl mx-auto">
                    Diambil dari hasil panen pertanian seperti padi, gandum, atau buah setelah mencapai nisab tertentu
                </p>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            <div class="rounded-2xl overflow-hidden shadow-lg">
                                <img src="{{ asset('img/program/zakat-pertanian.jpg') }}" alt="Zakat Pertanian" class="w-full h-64 object-cover">
                            </div>
                            ...
                            <div class="mt-6 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl p-6 border border-amber-200">
                                ...
                                <p class="text-center text-amber-600 mt-2">dari semua campaign zakat pertanian</p>
                                ...
                                <div class="mt-4 text-center">
                                    <a href="{{ route('campaigns.index', $category) }}"
                                        class="inline-block bg-gradient-to-r from-amber-600 to-orange-600 text-white px-4 py-2 rounded-lg hover:from-amber-700 hover:to-orange-700 transition-all duration-300 font-semibold text-sm shadow-lg">
                                        Lihat Campaign
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="lg:col-span-2">
                            <h2 class="text-3xl font-bold text-amber-800 mb-4">Tentang Zakat Pertanian</h2>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                                Zakat pertanian adalah zakat yang diwajibkan atas hasil pertanian seperti padi, gandum, kurma, anggur, dan hasil bumi lainnya yang telah mencapai nisab tertentu. Zakat ini menjadi kewajiban ketika hasil panen telah mencapai batas minimum yang ditetapkan syariat.
                            </p>

                            <h3 class="text-2xl font-bold text-amber-700 mb-3">Hukum Zakat Pertanian</h3>
                            <ul class="list-disc list-inside text-gray-700 mb-6 space-y-2">
                                <li>Wajib bagi petani yang hasil pertaniannya mencapai nisab</li>
                                <li>Nisab zakat pertanian adalah 5 wasaq (sekitar 653 kg) untuk tanaman yang diairi dengan air hujan</li>
                                <li>Nisab zakat pertanian adalah 10 wasaq (sekitar 1306 kg) untuk tanaman yang diairi dengan biaya</li>
                                <li>Dikeluarkan saat masa panen tiba</li>
                            </ul>
                            ...
                            <div class="bg-amber-50 rounded-xl p-4 mb-6">
                                ...
                                <ul class="space-y-1 text-amber-700">
                                    <li class="flex items-start">
                                        ...
                                        <span>Pembagian kepada fakir miskin hasil panen pertanian</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Program kesejahteraan petani kurang mampu</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Peningkatan sarana dan prasarana pertanian</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="text-center mt-8">
                                <a href="{{ route('guest.payment.create', ['category' => 'zakat-pertanian']) }}"
