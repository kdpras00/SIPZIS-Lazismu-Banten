...
@section('title', 'Program Kesehatan - SIPZIS')
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="mt-6 bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl p-6 border border-green-200">
                                ...
                                <p class="text-center text-green-600 mt-2">dari semua donasi program kesehatan</p>
                        ...
                        <div class="lg:col-span-2">
                            <h2 class="text-3xl font-bold text-green-800 mb-4">Tentang Program Kesehatan</h2>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                                Program Kesehatan SIPZIS bertujuan untuk meningkatkan kesehatan masyarakat melalui berbagai inisiatif yang mencakup pembangunan klinik, penyediaan obat, dan layanan kesehatan. Kami percaya bahwa kesehatan adalah hak semua orang.
                            </p>

                            <h3 class="text-2xl font-bold text-green-700 mb-3">Fokus Program</h3>
                            <ul class="list-disc list-inside text-gray-700 mb-6 space-y-2">
                                <li>Pembangunan dan renovasi fasilitas kesehatan</li>
                                <li>Penyediaan obat-obatan dan alat kesehatan</li>
