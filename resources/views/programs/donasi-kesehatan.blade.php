        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="text-center mb-12 relative">
                ...
                <p class="text-xl text-green-800 max-w-2xl mx-auto">
                    Meningkatkan kesehatan masyarakat melalui berbagai inisiatif
                </p>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="bg-green-50 rounded-xl p-4 mb-6">
                                ...
                                <ul class="space-y-1 text-green-700">
                                    <li class="flex items-start">
                                        ...
                                        <span>Pembangunan dan renovasi fasilitas kesehatan</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-green-500 mr-2">•</span>
                                        <span>Penyediaan obat-obatan dan alat kesehatan</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-green-500 mr-2">•</span>
                                        <span>Pelatihan tenaga kesehatan</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="text-center mt-8">
                                <a href="{{ route('guest.payment.create', ['category' => 'kesehatan']) }}" 
