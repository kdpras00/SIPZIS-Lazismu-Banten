                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="mt-6 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl p-6 border border-amber-200">
                                ...
                                <p class="text-center text-amber-600 mt-2">dari semua campaign zakat fitrah</p>
                        ...
                        <div class="lg:col-span-2">
                            <h2 class="text-3xl font-bold text-amber-800 mb-4">Tentang Zakat Fitrah</h2>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                                Zakat Fitrah adalah zakat yang wajib dikeluarkan oleh setiap muslim menjelang Hari Raya Idul Fitri. Zakat ini merupakan bentuk ibadah dan rasa syukur kepada Allah SWT atas nikmat yang diterima selama bulan Ramadhan.
                            </p>

                            <h3 class="text-2xl font-bold text-amber-700 mb-3">Ketentuan Zakat Fitrah</h3>
                            <ul class="list-disc list-inside text-gray-700 mb-6 space-y-2">
                                <li>Wajib bagi setiap muslim yang memiliki harta melebihi kebutuhan pokok</li>
                                <li>Dikeluarkan sebelum shalat Idul Fitri</li>
                                <li>Besarannya setara dengan 3,5 liter beras atau makanan pokok setempat</li>
                                <li>Dapat dikeluarkan dalam bentuk uang sesuai harga beras di daerah setempat</li>
                            </ul>
                            ...
                            <div class="bg-amber-50 rounded-xl p-4 mb-6">
                                ...
                                <ul class="space-y-1 text-amber-700">
                                    <li class="flex items-start">
                                        ...
                                        <span>Pembagian kepada fakir dan miskin</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                    ...
                                    <li class="flex items-start">
                                        <span class="text-amber-500 mr-2">•</span>
                                        <span>Membantu kebutuhan ibadah umat Islam</span>
                                    </li>
                                </ul>
                            </div>
