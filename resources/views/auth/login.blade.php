...
<div class="relative bg-gradient-to-br from-green-900 via-green-800 to-emerald-700 min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="animate-fadeInUp delay-700">
                    ...
                    <input id="password" type="password" 
                        class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-green-200 focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent backdrop-blur-sm transition-all duration-300 @error('password') border-red-400 @enderror"
                        name="password" 
    ...
    <a href="{{ route('home') }}" class="absolute bottom-6 left-6 inline-flex items-center text-green-200 hover:text-white transition-colors duration-300 animate-fadeInUp delay-1700">
...
<style>
    /* ... (CSS yang sudah ada tidak perlu diubah, kecuali jika Anda ingin menyesuaikan animasi) ... */
